...
This was one of the most facinating concepts to me when I began my graduate program. We processed an image in python and played around with the different resolutions we could provide based on the values provided. 
...
- **outside_rec**: binary varibale if the receiver caught the ball outside the hashes
...
Using $SVD$ to get the principle components, we can use the largest 2 to explain the ~54% of the variance. 
